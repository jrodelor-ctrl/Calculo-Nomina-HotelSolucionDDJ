 ...
 * Permite autenticar usuarios según su rol.
 */
...
public class LoginView {
    ...
    private StackPane construirVista() {
        ...
        Label ayuda = new Label("Usuarios: gerente / 1234   |   rrhh / 1234");
        ...
        loginCard.getChildren().addAll(loginTitle, txtUsuario, txtPassword, btnIngresar, ayuda, mensaje);
